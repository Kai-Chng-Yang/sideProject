...
def tem_curve(data):
 ...
 plt.figure(1)
 plt.plot(x,y,color='red',label='溫度')       # 画出温度曲线
 plt.scatter(x,y,color='red')   # 点出每个时刻的温度点
 plt.plot([0, 24], [tem_ave, tem_ave], c='blue', linestyle='--',label='平均溫度')  # 画出平均温度虚线
...
def main():
 plt.rcParams['font.sans-serif']=['Noto Sans TC'] # 解决中文显示问题
